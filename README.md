...
| Package/member references (`my_pkg.item`, `work.my_pkg.item`) | Package declaration/member entry (library-aware when available) |
| General identifier | Local declaration/parameter, package member, package, callable, entity/component |
